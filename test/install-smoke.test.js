  ...
  try {
    ...
    execFileSync(process.execPath, [
      ...
      [
        ...
        "if (!Array.isArray(server.TOOLS) || server.TOOLS.length !== 110) process.exit(2);",
        ...
        "if (!server.TOOLS.some((tool) => tool.name === 'bounty_import_mobile_artifact')) process.exit(25);",
        "if (!server.TOOLS.some((tool) => tool.name === 'bounty_android_static_scan')) process.exit(26);",
        "if (!server.TOOLS.some((tool) => tool.name === 'bounty_register_mobile_device_profile')) process.exit(27);",
        "if (!server.TOOLS.some((tool) => tool.name === 'bounty_list_mobile_device_profiles')) process.exit(28);",
        "if (!server.TOOLS.some((tool) => tool.name === 'bounty_acquire_mobile_device_lease')) process.exit(29);",
        "if (!server.TOOLS.some((tool) => tool.name === 'bounty_release_mobile_device_lease')) process.exit(30);",
