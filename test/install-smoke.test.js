  ...
  try {
    ...
    execFileSync(process.execPath, [
      ...
      [
        ...
        "if (!Array.isArray(server.TOOLS) || server.TOOLS.length !== 50) process.exit(2);",
        ...
        "if (!server.TOOLS.some((tool) => tool.name === 'bounty_select_technique_packs')) process.exit(15);",
        "if (!server.TOOLS.some((tool) => tool.name === 'bounty_read_technique_pack')) process.exit(16);",
        "if (!server.TOOLS.some((tool) => tool.name === 'bounty_log_technique_attempt')) process.exit(17);",
        "if (!server.TOOLS.some((tool) => tool.name === 'bounty_get_context_budget')) process.exit(18);",
