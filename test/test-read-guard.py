...
TESTS = [
    ...
    ("Read handoff signing key blocks",
     ...
     2,
     "bounty_read_session_summary"),
    ("Read mobile artifacts ledger blocks",
     {"tool_input": {"file_path": f"{SESSION}/mobile-artifacts.jsonl"}},
     2,
     "bounty_read_session_summary"),
    ("Read mobile artifact binary blocks",
     {"tool_input": {"file_path": f"{SESSION}/mobile-apps/MA-1.bin"}},
     2,
     "bounty_read_session_summary"),
    ("Read mobile device profile ledger blocks",
     {"tool_input": {"file_path": f"{SESSION}/mobile-device-profiles.jsonl"}},
     2,
     "bounty_read_session_summary"),
    ...
    ("Bash cat handoff signing key blocks",
     ...
     2,
     "bounty_read_session_summary"),
    ("Bash strings mobile artifact blocks",
     {"tool_input": {"command": f"strings {SESSION}/mobile-apps/MA-1.bin"}},
     2,
     "bounty_read_session_summary"),
    ("Bash cat mobile trace blocks",
     {"tool_input": {"command": f"cat {SESSION}/mobile-traces/session.pcapng"}},
     2,
     "bounty_read_session_summary"),
    ("Bash cat mobile screenshot blocks",
     {"tool_input": {"command": f"cat {SESSION}/screenshots/login.png"}},
     2,
     "bounty_read_session_summary"),
