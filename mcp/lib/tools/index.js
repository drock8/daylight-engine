...
const TOOL_MODULES = Object.freeze([
  ...
  require("./import-mobile-artifact.js"),
  require("./android-static-scan.js"),
  require("./register-mobile-device-profile.js"),
  require("./list-mobile-device-profiles.js"),
  require("./acquire-mobile-device-lease.js"),
  require("./release-mobile-device-lease.js"),
