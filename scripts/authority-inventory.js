...
const EXPLICIT_AUTHORITY_CLASS_BY_TOOL = Object.freeze({
  ...
  bounty_acquire_mobile_device_lease: "initialized_session_mutation",
  bounty_android_static_scan: "initialized_session_mutation",
  bounty_import_mobile_artifact: "initialized_session_mutation",
  ...
  bounty_list_mobile_device_profiles: "initialized_session_read",
  ...
  bounty_register_mobile_device_profile: "initialized_session_mutation",
  bounty_release_mobile_device_lease: "initialized_session_mutation",
...
function flags(tool) {
  return [
    ...
    `device_access=${tool.device_access && tool.device_access.required ? tool.device_access.actions.join("+") : "false"}`,
